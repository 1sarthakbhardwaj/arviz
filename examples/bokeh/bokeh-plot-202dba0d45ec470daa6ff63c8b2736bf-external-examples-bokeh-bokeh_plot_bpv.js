(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("98d1ba20-85df-4015-b247-2540aaeaa04c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '98d1ba20-85df-4015-b247-2540aaeaa04c' but no matching script tag was found.")
        }
